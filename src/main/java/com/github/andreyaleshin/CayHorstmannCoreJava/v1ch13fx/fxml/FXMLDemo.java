//package com.github.andreyaleshin.CayHorstmannCoreJava.v1ch13fx.fxml;
//
//import java.io.*;
//import java.net.*;
//import java.util.*;
...
//import javafx.stage.*;
//
//// Для программной установки контроллера рекомендуется использовать исходный код
//// из предыдущего примечания (с.793).
//
///**
